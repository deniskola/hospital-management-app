        ...
        <div class="left-container">
          ...
          <p.BodyInfo>
            <div class="body-first-container">
              <div>
                <p class="upper-items">Age:</p>
                <b class="data">58</b>
              </div>
              <div class="vertical-line">
                <p class="upper-items">Weight:</p>
                <b class="data">70</b>
              </div>
              <div class="vertical-line">
                <p class="upper-items">Blood Group:</p>
                <b class="data">AB</b>
              </div>
            </div>
        ...
        <div class="right-container">
                  ...
                  <TableRow key={pAllergies.id}>
                    ...
                    <TableCell>
                      <ButtonGroup variant="text">
                        <Button basic color="purple" width="1">
                          <i class="edit icon"></i>
                        </Button>
                        <Button basic color="purple" width="1">
          ...
          <p.History>
            <div class="upper-container">
              ...
              <p>
                <b>Patient History</b>
                <i class="angle right icon"></i>2021
                <i class="angle down icon"></i>All
                <i class="angle down icon"></i>
              </p>
            </div>
            <div class="lower-container">
